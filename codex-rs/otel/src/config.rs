...
pub(crate) fn resolve_exporter(exporter: &OtelExporter) -> OtelExporter {
    match exporter {
        // Telemetry is permanently disabled. Statsig endpoints and credentials are
        // retained only for reference in the enum definition; the runtime path always
        // yields None regardless of build profile or configuration override.
